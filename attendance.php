    ...
    <?php include('nav_bar.php') ?>
        ...
        <div class="well col-lg-12">
			...
			<br/>
                ...
                <tbody>
                <?php
                    $attendance_qry = $conn->query("SELECT a.*, CONCAT(e.firstname, ' ', e.middlename, ' ', e.lastname) AS name, e.employee_no FROM `attendance` a INNER JOIN `employee` e ON a.employee_id = e.id") or die($conn->error);
